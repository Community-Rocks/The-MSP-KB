...
* **Fine-tuning vs. alignment.** The \[\[RLHF and Alignment]] paper is itself a _kind_ of fine-tuning, but on human-preference data rather than task labels — showing the paradigm evolved rather than disappeared. Fine-tuning did not die; it changed target.
